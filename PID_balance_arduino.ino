...
void setup() {
  ...
  Serial.begin(250000);
  right_prop.attach(6); //attatch the right motor to pin 3      hinten rechts 11 vorne rechts 6
  left_prop.attach(5);  //attatch the left motor to pin 5     hinten links 10 vorne links 5
  right2_prop.attach(11);
  left2_prop.attach(10);
  ...
  left2_prop.writeMicroseconds(1000);
  right2_prop.writeMicroseconds(1000);
...
left2_prop.writeMicroseconds(pwmLeft);
right2_prop.writeMicroseconds(pwmRight);
